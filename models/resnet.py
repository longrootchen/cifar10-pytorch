...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_classes, block_name='BasicBlock'):
        ...
        # ResNet architecture with specifies number of layers for CIFAR-10 or CIFAR-100 dataset
        ...
        self.relu = nn.ReLU(inplace=True)
        self.stage1 = self._make_layer(block, 16, n)
        self.stage2 = self._make_layer(block, 32, n, stride=2)
        self.stage3 = self._make_layer(block, 64, n, stride=2)
